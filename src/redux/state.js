let store = {
    ...
    dispatch (action) {
        ...
        {
            let newPost = {
                preview: 'https://wow.zamimg.com/uploads/blog/images/17020-wow-classic-15.jpg',
                title: 'Новая новость',
            ...
            this._state.newsData.unshift(newPost);
...
export const addNewPostrActionCreator = (text) => {
    return (
      {
        type: ADD_POST,
        postMessage: text
